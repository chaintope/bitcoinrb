...
describe Bitcoin::Payments do
  ...
  describe 'PaymentRequest#parse_from_payload' do
    ...
    it 'should be parsed.' do
      ...
      expect(details.outputs[0].to_tx_out.script_pubkey.to_addr).to eq('mmy7BEH1SUGAeSVUR22pt5hPaejo2645F1')
      expect(details.outputs[1].to_tx_out.value).to eq(10000)
      expect(details.outputs[1].to_tx_out.script_pubkey.to_addr).to eq('mmy7BEH1SUGAeSVUR22pt5hPaejo2645F1')
