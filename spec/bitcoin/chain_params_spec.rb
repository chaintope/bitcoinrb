  ...
  describe 'load params' do
    ...
    context 'mainnet' do
      ...
      it do
        ...
        expect(subject.genesis_block.header.hash).to eq('6fe28c0ab6f1b372c1a6a246ae63f74f931e8365e15a089c68d6190000000000')
      end
    end
    ...
    context 'testnet' do
      ...
      it do
        ...
        expect(subject.genesis_block.header.hash).to eq('43497fd7f826957108f4a30fd9cec3aeba79972084e90ead01ea330900000000')
      end
    end
    ...
    context 'regtest' do
      ...
      it do
        ...
        expect(subject.genesis_block.header.hash).to eq('06226e46111a0b59caaf126043eb5bbf28c34f3a5e332a1fc7b2b73cf188910f')
      end
    end
  end
